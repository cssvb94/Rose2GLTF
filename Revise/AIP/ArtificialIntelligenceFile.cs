...
namespace Revise.AIP
{
    ...
    public class ArtificialIntelligenceFile : FileLoader {
        ...
        public override void Load(Stream stream) {
            ...
            AlignedBinaryReader alignedReader = new(stream, Encoding.GetEncoding("us-ascii"));
        ...
        public override void Save(Stream stream) {
            ...
            AlignedBinaryWriter alignedWriter = new(stream, Encoding.GetEncoding("us-ascii"));
