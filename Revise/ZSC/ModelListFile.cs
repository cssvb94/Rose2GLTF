...
namespace Revise.ZSC
{
    ...
    public class ModelListFile : FileLoader
    {
        ...
        {
            BinaryReader reader = new(stream, Encoding.GetEncoding("us-ascii"));
            ...
            for (int i = 0; i < textureFileCount; i++)
            {
                TextureFile texture = new()
                {
                    ...
                    UseSkinShader = reader.ReadInt16() != 0,
                    AlphaEnabled = reader.ReadInt16() != 0,
                    TwoSided = reader.ReadInt16() != 0,
                    AlphaTestEnabled = reader.ReadInt16() != 0,
                    AlphaReference = reader.ReadInt16(),
                    DepthTestEnabled = reader.ReadInt16() != 0,
                    DepthWriteEnabled = reader.ReadInt16() != 0,
                    BlendType = (BlendType)reader.ReadInt16(),
                    UseSpecularShader = reader.ReadInt16() != 0,
                    Alpha = reader.ReadSingle(),
                    GlowType = (GlowType)reader.ReadInt16(),
                    GlowColour = reader.ReadColour3()
                };
        ...
        {
            BinaryWriter writer = new(stream, Encoding.GetEncoding("us-ascii"));
